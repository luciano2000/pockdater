...
namespace Pockdater.Models.Settings;
...
public class Config
{
    ...
    [Description("Delete cores, not managed by pockdater, during 'Update All'")]
    ...
    [Description("Automatically install updates to Pockdater")]
    ...
    [Description("Timeout in seconds for individual file downloads (default: 100)")]
    public int download_timeout_seconds { get; set; } = 100;
